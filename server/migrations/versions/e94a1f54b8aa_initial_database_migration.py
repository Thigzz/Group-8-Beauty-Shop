...
Revision ID: e94a1f54b8aa
Revises: 
Create Date: 2025-09-18 16:37:42.218686
...
def upgrade():
    ...
    sa.Column('user_id', server.app.models.base.GUID(), nullable=True),
    ...
    sa.Column('user_id', server.app.models.base.GUID(), nullable=False),
    sa.Column('admin_id', server.app.models.base.GUID(), nullable=False),
    ...
    sa.Column('user_id', server.app.models.base.GUID(), nullable=False),
    sa.Column('question_id', server.app.models.base.GUID(), nullable=True),
    sa.Column('action', sa.String(), nullable=False),
    sa.Column('performed_by', server.app.models.base.GUID(), nullable=True),
    sa.Column('id', server.app.models.base.GUID(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=True),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), nullable=True),
    ...
    sa.Column('user_id', server.app.models.base.GUID(), nullable=False),
    sa.Column('question_id', server.app.models.base.GUID(), nullable=False),
    ...
    sa.Column('cart_id', server.app.models.base.GUID(), nullable=False),
    ...
    sa.Column('cart_id', server.app.models.base.GUID(), nullable=False),
    sa.Column('product_id', server.app.models.base.GUID(), nullable=False),
